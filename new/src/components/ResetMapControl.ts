...
/**
 * Custom Mapbox control that resets the map to its initial center and zoom
 */
export class ResetMapControl implements mapboxgl.IControl {
...
-15 372z"/>
    ...
    button.addEventListener('click', () => {
      if (this._map) {
        ...
        // Clear position params from URL
