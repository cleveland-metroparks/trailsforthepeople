...
// var markerLayer = L.featureGroup(); // @TODOGLJS
var userLocation;
...
function displayActivities(activities) {
    ...
    for (i = 0; i < activities.length; i += 1) {
        ...
        // markerLayer.addLayer(marker); // @TODOGLJS
    }
    // markerLayer.addTo(MAP); // @TODOGLJS
