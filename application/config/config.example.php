...
$config['ssl_url']	= 'https://ururlhere.com/';
...
$config['admin_pass'] = "hashapasswithsalt";


/*
|--------------------------------------------------------------------------
| My own geospatial location, Lat & Lon, and search radius in miles
|--------------------------------------------------------------------------
*/
$config['geo_lat'] = 41.3953;
$config['geo_lon'] = -81.674;
$config['geo_miles'] = 30;


/*
|--------------------------------------------------------------------------
| Re-CAPTCHA slows down hackers trying to brute force the Contributor and Admin systems
|--------------------------------------------------------------------------
*/
$config['recaptcha_public_key']  = "pubkeyhere";
$config['recaptcha_private_key'] = "prikeyhere";
...
|
*/
$config['encryption_key'] = 'gimmeyourkeyhere';
